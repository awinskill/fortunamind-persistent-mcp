...
# We'll define these models next
try:
    from fortunamind_persistence.storage.models import Base
    target_metadata = Base.metadata
except ImportError:
    # If models don't exist yet, we'll create them manually in migrations
